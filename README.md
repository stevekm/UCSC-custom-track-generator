...
```bash
find sample-data/mixed/ -type f ! -name "*.bai" | xargs ./make-tracks.py -url http://myserver.edu.external/test1.bw -p bigwig_params.txt -o my_custom_tracks.txt
...
```bash
track type=BED name="test.bed" url=http://myserver.edu.external/test1.bw/test.bed visibility=full autoScale=off alwaysZero=on maxHeightPixels=50 graphType=bar viewLimits=0:0.3
track type=BAM name="test.bam" bigDataUrl=http://myserver.edu.external/test1.bw/test.bam visibility=full autoScale=off alwaysZero=on maxHeightPixels=50 graphType=bar viewLimits=0:0.3
track type=bigWig name="test.bw" bigDataUrl=http://myserver.edu.external/test1.bw/test.bw visibility=full autoScale=off alwaysZero=on maxHeightPixels=50 graphType=bar viewLimits=0:0.3
```
